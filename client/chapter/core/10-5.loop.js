...
//   2: 'div',
//   length: 3
//   // [Symbol.iterator]{...} -> 이게 내장되어 있어야지 반복이 가능하다.
// }
...
for(let value of languages){
  ...
  // 이름에 Java가 들어가는 && name의 길이가 5보다 작은
...
// Object.keys()
// Object.values()
// Object.entries() : 객체를 배열로 반환 -> 객체에서 받은 key, value를 하나의 쌍으로 담은 배열

// object는 static method, entries는 [key, value] 쌍 값을 불러온다.
