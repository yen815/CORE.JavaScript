...
// // const value = sum(1,3) // value엔 4가 담긴다.
// const value = sum // value엔 함수 본문이 담긴다.
// value()
...
const c2 = counter()
const c3 = counter()
// 전역 실행컨텍스트에서 3개의 함수 실행 컨텍스트가 생성
// 스택에서 3개의 스택이 쌓인게 아니라 실행컨텍스트에서 3개의 함수 실행 컨텍스트가 생성
// c1을 없애기 위해서는 변수에 null을 준다. 그러면 메모리에서도 삭제 (잃어버린 섬) 된다.
// 같은 로직인데, 서로 다른 값을 가져야 할때 사용하면 좋다.
